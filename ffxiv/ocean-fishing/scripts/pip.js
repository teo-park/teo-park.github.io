(() => {
  ...
  function mount({getView,setStop,changeCatch,undoCatch,openMain}) {
    ...
    function update(){if(isOpen()){view=getView();paint();}}
    ...
    async function open(){
      ...
      try{
        ...
        for(const path of ['../../theme.css?v=20260909-line1','../css/app.css?v=20260913-ocean-pip','../css/pip.css?v=20260913-ocean-pip']){const link=d.createElement('link');link.rel='stylesheet';link.href=new URL(path,location.href).href;d.head.append(link);}
